<x-app-layout>
    <header>
        <div class="from-teal-100 via-teal-100 to-teal-100 bg-gradient-to-br">
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Registrar los nuevos roles</h1>
        </div>
    </header>
    <!--component -->
        ...
        <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
            <div class='max-w-md mx-auto space-y-6'>
                <form action="{{route('role.store')}}" method="POST">
                    ...
                    <p class="my-4 opacity-70">Rellenar todos los campos del nuevo rol a registrarse</p>
                    <hr class="my-6">
