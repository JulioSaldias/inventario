<x-app-layout>
    <header>
    <div class=" from-teal-100 via-teal-100 to-teal-100 bg-gradient-to-br"></div>
    </header>
    <!--component -->
    ...
    <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
        ...
        <div class='max-w-md mx-auto space-y-6'>
            ...
            <form action="{{route('categoria.store')}}" method="POST">
                ...
                <p class="my-4 opacity-70">Rellene todos los campos de la nueva categoria a registrar</p>
                <hr class="my-6">
                ...
                <input class="w-full p-3 mt-2 mb-4 bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none" type="text" name="descripcion">
                ...
                <button class="py-3 px-6 my-2 bg-red-500 text-white font-medium rounded hover:bg-red-500 cursor-pointer ease-in-out duration-300"><a href="{{route('categoria.principal')}}">Cancelar</a></button>
            </form>
