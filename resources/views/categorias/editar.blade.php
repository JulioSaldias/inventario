    ...
    <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
        ...
        <div class='max-w-md mx-auto space-y-6'>
            ...
            <form action="{{route('categoria.update',$categoria)}}" method="POST">
                ...
                <input  value="{{$categoria->descripcion}}" class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none" type="text" name="descripcion">
